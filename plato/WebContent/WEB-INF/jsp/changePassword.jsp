  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form:form method="POST" commandName="user" modelAttribute="user" action="confirmPassword.html">
          ...
          <div class="form-group has-feedback">
          	...
          	<form:input path="oldPassword" value="${key}" type="password" class="form-control" placeholder="Old Password"/>
           ...
           <div class="form-group has-feedback">
          	...
          	<form:input path="newPassword" value="${user.newPassword}" type="password" class="form-control" placeholder="New Password"/>
            <!--  <input type="password" class="form-control" placeholder="Password">-->
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
