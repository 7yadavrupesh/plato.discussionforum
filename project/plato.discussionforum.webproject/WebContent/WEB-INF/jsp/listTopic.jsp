            ...
            <section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="listTopic.html"> <i
						...
						<ul class=" treeview-menu">
							<li class="active"><a href="#"><i class="fa fa-list"></i> Show <i
									class="fa fa-angle-left pull-right"></i></a>
								<ul class="treeview-menu">
								...
								<table id="example1" class="table table-bordered">
									...
									<tbody>
										<c:forEach items="${topics}" var="topic">
											<tr>
												<td><a href="listThreadTopic.html?topic_id=${topic.key.topicId}">
														<c:out value="${topic.key.topicTitle}" />
												</a></td>
												<td><c:out value="${topic.key.createdTime}" /></td>
												<td><c:out value="${topic.value}" /></td>
												<td><c:out value="${topicWiseThreadList[topic.key.topicId]}" /></td>
												<td><c:choose>
														<c:when test="${moderatorAllowMap[topic.key.topicId] == true }">
															...
															<a onclick="return confirm_delete(this);" href="deleteTopic.html?topic_id=${topic.key.topicId}"><span
