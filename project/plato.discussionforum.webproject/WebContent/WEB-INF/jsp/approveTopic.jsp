									...
									<tbody>
										<c:forEach items="${approveTopics}" var="topic">
											<tr>
												...
												<td><a
													href="saveApproveTopic.html?topic_id=${topic.key.topicId}"
													title="approve"><span class="fa fa-check"></span></a>
													&nbsp; &nbsp; <a onclick="return disapprove(this);"
													class="disapprove"
													href="disApproveTopic.html?topic_id=${topic.key.topicId}"
													title="disapprove"><span class=" fa fa-remove"></span></a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
					...
					<div class="modal-dialog modal-sm">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4>
									<span class="glyphicon glyphicon-lock"></span> Disapprove Topic
								</h4>
							</div>
								...
								<div id="form">
									<div class="form-group">
										...
										<textarea rows="6" name="message" class="form-control" id="message"
											placeholder="Reason for disapprove"></textarea>
									</div>
							...
							<h4><div class="text-green" id="disapproveSuccess"></div></h4>
							</div>
		...
		$("#submitReport").click(
				function() {
					if ($("#message").val().length >= 10) {
						$("#errorMsg").hide();
						$("#disapproveSuccess").text("Disapprove Topic Successful");
						$("#form").hide();
						$("#cancel").text("Ok");
						var $form = $("form");
						$.ajax({
