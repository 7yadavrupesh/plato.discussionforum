        ...
        <div class="wrapper">
          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                Student List
                <small>Choose any student to view profile </small>
              </h1>
              <ol class="breadcrumb">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<c:forEach items="${studentList}" var="studentList">
											<tr>
												<td><a href="viewUserProfile.html?id=${studentList.studentNo}">
														<c:out value="${studentList.studentId}" />
												</a></td>
												<td><c:out value="${studentList.firstName} ${studentList.lastName}" /></td>
												<td><c:out value="${studentList.qualification}" /></td>
												<td><c:out value="">
												</c:out>
												</td>
												<td><c:out value="${studentList.emailId}">
												</c:out>
												</td>
												<td>
												<button id = "${studentList.studentNo}" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#roleModal">
  													Add new Role
												</button>
													<%-- <button id = "${studentList.studentNo}" href="#" onclick = "addRole(this.id)" >
														<span class="fa fa-plus" title="plus"></span>
													</a>--%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Assign a new Role</h4>
      </div>
      <div class="modal-body">
        <select>
        <option value="0">Select a role to assign</option>
      ...
      <div class="modal-footer">
        ...
        <button id = "assignRole" type="button" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div>   
