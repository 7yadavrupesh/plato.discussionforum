        ...
        <div class="wrapper">
          ...
          <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                Faculty List
                <small>Choose any faculty to view profile </small>
              </h1>
              <ol class="breadcrumb">
									...
									<tbody>
										<c:forEach items="${facultyList}" var="facultyList">
											<tr>
												...
												<td>
												<a href="viewUserProfile.html?id=${facultyList.facultyId}">
												<c:out value="${facultyList.firstName} ${facultyList.lastName}" />
												</td>
												<td><c:out value="${facultyList.qualification}" /></td>
												<td>
												<c:set var="id" value="${facultyList.facultyId }" /> 
												<c:out value="${facultyDetails[id]}">
												</c:out>
												
												</td>
												
												<td><c:out value="${facultyList.emailId}">
												</c:out>
												</td>
												<td>
												<button id = "${facultyList.facultyId}" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#roleModal">
  													Add new Role
												</button>
