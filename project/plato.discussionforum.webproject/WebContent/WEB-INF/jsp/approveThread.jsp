...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				</ul>		class="fa fa-angle-left pull-right"></i></a></li>
				</ul>
			</section>
			<!-- /.sidebar -->
		</aside>
									...
									<tbody>
										<c:forEach items="${deletedThreads}" var="thread">
											<tr>
												...
												<td><a
													href="saveApproveThread.html?thread_id=${thread.key.threadId}"><span
														class="fa fa-check" title="approve"></span></a>&nbsp;&nbsp; <a
													onclick="return disapprove(this);"
													href="deleteThread.html?thread_id=${thread.key.threadId}&frmAprThr=1"><span
					...
					<div class="modal-dialog modal-sm">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4>
									<span class="glyphicon glyphicon-lock"></span> Disapprove
									Thread
								</h4>
							</div>
								...
								<div id="form">
									<div class="form-group">
										<label for="usrname"><span
											class="glyphicon glyphicon-user"></span> Reason </label>
										<textarea rows="6" name="message" class="form-control"
											id="message" placeholder="Reason for disapprove"></textarea>
									</div>
									<div class="solid form-group">
										<div class="text-red" id="errorMsg"></div>
									</div>
									<button id="submitReport" type="submit"
										class="btn btn-success btn-block">
										<span class="glyphicon glyphicon-off"></span> Report
									</button>
								</div>
								<h4>
									<div class="text-green" id="disapproveSuccess"></div>
								</h4>
							</div>
	...
	<script>
      $(function () {
		...
		var disapproveUrl = 0;
		var baseUrl = 0;
		function disapprove(node) {
			redirectUrl = node.baseURI;
			disapproveUrl = node.href;
			baseUrl = node.attributes.href.ownerDocument.referrer;
			$("#disapprovemodel").modal();
			return false;
		}
		function wait() {
			setTimeout(
		...
		$("#submitReport").click(
				function() {
					if ($("#message").val().length >= 10) {
						$("#errorMsg").hide();
						$("#disapproveSuccess").text("Disapprove Thread Successful");
						$("#form").hide();
						$("#cancel").text("Ok");
						var $form = $("form");
						$.ajax({
							url : disapproveUrl + "&message="
									+ $("#message").val(),
							data : $form.serialize(),
							type : "GET",
						...
						$("#errorMsg").text("10 characters are required")
								.show();
