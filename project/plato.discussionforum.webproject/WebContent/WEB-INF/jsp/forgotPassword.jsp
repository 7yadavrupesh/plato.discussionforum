  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form:form method="POST" commandName="email" modelAttribute="email" action="resetPassword.html">
          <div class="form-group has-feedback">
          
                   
          	<form:input path="email" value=" ${email.email}" type="email" class="form-control" placeholder="Email"/>
