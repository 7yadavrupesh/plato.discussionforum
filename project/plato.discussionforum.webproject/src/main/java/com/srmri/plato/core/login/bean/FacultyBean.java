...
***********************************************************************************
* Description: Faculty form and validation bean
**********************************************************************************/
...
public class FacultyBean implements Serializable
{
	...
	private static final long serialVersionUID = -707072581198377521L;
	...
	@Size(min=1, max=255, message="Not a valid date")
